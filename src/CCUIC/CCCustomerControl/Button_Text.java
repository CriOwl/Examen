...
public class Button_Text extends JButton {
    ...
    private void customizeComponent(String text, String iconPath,Font font,Color color){ 
        setSize(20, 70);
    ...
    private void customizeComponent(String text,Font font,Color color) {
        setText(text);
        setOpaque(false);
        ...
        setForeground(color);
        setFont(font);
        setHorizontalAlignment(EcuAnt.ALIGNMENT_CENTER);
